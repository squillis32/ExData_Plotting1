...
plot(x = household_power_consumption_data$Time3, y = household_power_consumption_data$Sub_metering_1, type = "S", xlab = "", ylab = "Energy sub metering", col = "black", ylim = c(0, 25))
